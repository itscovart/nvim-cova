...
keymap("n", "<leader>tmd", function()
	insert_template("~/.config/nvim/templates/md.md", "Markdown template inserted")
end, {
...
keymap("n", "<leader>tarpdf", function()
	...
	local template = vim.fn.shellescape(vim.fn.expand("~/.config/nvim/templates/escom-template.tex"))
...
keymap("n", "<leader>tc", function()
	insert_template("~/.config/nvim/templates/cpp.cpp", "C++ template inserted")
end, {
...
vim.keymap.set("v", "<leader>css", "<cmd>CodeSnapSave<CR>", {
	desc = "CodeSnap Save",
})
